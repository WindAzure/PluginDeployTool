...
namespace PluginDeployTool.DeployCommands
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class DeployClientPlugin
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeployClientPlugin"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        /// <param name="commandService">Command service to add command to, not null.</param>
        private DeployClientPlugin(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static DeployClientPlugin Instance
        {
            get;
            private set;
        }
        ...
        {
            // Switch to the main thread - the call to AddCommand in DeployClientPlugin's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);

            OleMenuCommandService commandService = await package.GetServiceAsync((typeof(IMenuCommandService))) as OleMenuCommandService;
            Instance = new DeployClientPlugin(package, commandService);
        }
